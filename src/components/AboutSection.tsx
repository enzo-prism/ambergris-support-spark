      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        duration: 0.6
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 text-lg">Belize Kids is dedicated to improving the lives of children in Belize through strategic investments in education, healthcare, and community infrastructure.</p>
          </div>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
          {/* Left side with mission and impact card */}
          <motion.div className="md:col-span-5" initial={{
          opacity: 0,
          x: -30
        }} whileInView={{
          opacity: 1,
          ...
          duration: 0.7
            ...
            <Card className="p-6 shadow-md border-l-4 border-belize-green h-full">
              ...
              <ul className="space-y-2 mb-6">
                {impactPoints.map((point, index) => <motion.li key={index} initial={{
                opacity: 0,
                x: -10
              }} whileInView={{
                opacity: 1,
          ...
          <motion.div className="md:col-span-7" initial={{
          opacity: 0,
          x: 30
        }} whileInView={{
          opacity: 1,
