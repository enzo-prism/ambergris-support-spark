...
const AboutSection: React.FC = () => {
  ...
  const impactPoints = ["Improving education infrastructure", "Building and maintaining parks and playgrounds", "Supporting healthcare initiatives", "Providing scholarships for future leaders"];
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        >
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 text-base md:text-lg">Belize Kids is dedicated to improving the lives of children in Belize through strategic investments in education, healthcare, and community infrastructure.</p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
            <div className="md:w-8/12">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 text-center md:text-left">Join Our Community of Investors</h3>
