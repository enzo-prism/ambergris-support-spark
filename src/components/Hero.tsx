...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[90vh] sm:min-h-screen flex items-center pt-24 md:pt-16 pb-16 md:pb-8 px-6 md:px-0 bg-gradient-to-b from-belize-light via-white to-white overflow-hidden">
      ...
      <div className="container-custom relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        <div className="flex-1 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
            ...
            <Button 
              variant="outline" 
              className="border-belize-green text-belize-green hover:bg-belize-green hover:text-white text-base sm:text-lg px-6 py-2 sm:px-8 sm:py-6 w-full sm:w-auto mt-2 sm:mt-0"
              onClick={() => {
