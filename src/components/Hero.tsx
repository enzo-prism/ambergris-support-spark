...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[90vh] sm:min-h-screen flex items-center pt-36 md:pt-16 pb-16 md:pb-8 px-6 md:px-0 bg-gradient-to-b from-belize-light via-white to-white overflow-hidden">
