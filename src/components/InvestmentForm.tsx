...
const InvestmentForm: React.FC = () => {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    toast({
      title: "Monthly investment registration started",
      description: "Thank you for your interest! We'll contact you shortly to complete your investment setup.",
    });
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-belize-blue">Start Your Monthly Investment</h2>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="bg-belize-blue p-8 text-white">
                ...
                <div className="flex items-center mt-4">
                  ...
                  <span className="text-sm">Cancel your monthly investment anytime</span>
                </div>
              </div>
              
              <div className="p-8">
                <h3 className="text-xl font-bold text-belize-blue mb-6">Start Your Monthly Investment</h3>
