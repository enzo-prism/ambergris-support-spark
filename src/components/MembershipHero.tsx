...
const MembershipHero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[80vh] flex items-center pt-16 sm:pt-20 pb-8 sm:pb-10 bg-gradient-to-b from-belize-light via-white to-white overflow-hidden">
