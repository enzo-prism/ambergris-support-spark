...
const MembershipHero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[80vh] flex items-center pt-36 sm:pt-28 pb-16 sm:pb-10 px-6 md:px-0 bg-gradient-to-b from-belize-light via-white to-white overflow-hidden">
