...
const MembershipHero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[80vh] flex items-center pt-24 sm:pt-28 pb-12 sm:pb-10 px-4 md:px-0 bg-gradient-to-b from-belize-light via-white to-white overflow-hidden">
