  ...
  const recentPosts = [
    {
      ...
      excerpt: "Our recent vision clinic in San Pedro provided free eye exams and glasses to over 200 children.",
    ...
    },
    {
      ...
      excerpt: "Thanks to generous donations, we were able to provide backpacks and other essential school supplies to 150 children.",
    ...
    },
    {
      ...
      date: "August 5, 2023",
      excerpt: "Our annual summer health camp welcomed over 300 children this year, offering dental checkups and health education.",
