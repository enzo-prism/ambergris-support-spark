        ...
        <section className="py-16">
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto mb-16 text-center">
              <h1 className="text-4xl md:text-5xl font-bold text-belize-green mb-4">Our Leadership Team</h1>
            ...
            <div className="space-y-12">
              {/* Meet Our Leaders */}
              <div>
                <h2 className="text-3xl font-bold text-belize-green mb-8 text-center">Meet Our Leaders</h2>
                ...
                <div className="grid grid-cols-1 gap-10">
                  ...
                  <LeaderCard 
                    ...
                    role="Co-Founder" 
                    icon={Briefcase} 
                    imageSrc="https://imgur.com/lx4GcRr"
                    bio={<>
                        <p>
