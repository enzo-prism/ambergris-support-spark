        ...
        <div className="max-w-3xl mx-auto">
                          ...
                          {isMobile && (
                            <div className="mt-2">
                              ...
                              {doctor.services.length > 1 && (
                                <span className="text-xs text-gray-500 ml-1">+{doctor.services.length - 1} more</span>
                              )}
                            </div>
                          )}
          ...
          <div className="mb-4">
            ...
            <Tabs defaultValue="list" className="w-full">
              <TabsList className="w-full mb-2 bg-gray-100 p-1 rounded-md">
                          ...
                          {isMobile ? (
                            <div className="mt-1">
                              <div className="flex items-center gap-1">
                                ...
                                {doctor.services.length > 1 && (
                                  <span className="text-xs text-gray-500">+{doctor.services.length - 1}</span>
                                )}
                              </div>
                            </div>
                          ) : (
                        ...
                        <CardContent className="p-3">
                          ...
                          {isMobile ? (
                            <div className="mt-1 mb-1">
                              ...
                              {doctor.services.length > 1 && (
                                <span className="text-xs text-gray-500 ml-1">+{doctor.services.length - 1}</span>
                              )}
                            </div>
                          ) : (
                  ...
                  <div>
                    ...
                    {isMobile ? (
                      <div className="flex items-center text-xs text-blue-700 mt-1">
                        <span className="bg-blue-50 px-2 py-0.5 rounded-full">{opening.service}</span>
                      </div>
                    ) : (
