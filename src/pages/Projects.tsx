...
const Projects: React.FC = () => {
  ...
  const metaDescriptionByTab: Record<string, string> = {
    all: "Discover our transparent community projects in Belize: school improvements, vision care, environmental education, marine conservation, and community fundraising.",
    ...
    education: "See education projects that improve schools, classrooms, learning spaces, and supplies for Belizean students.",
    environment: "Discover environmental education and marine conservation projects on Ambergris Caye.",
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Discover our transparent community projects in Belize: school improvements, vision care, environmental education, marine conservation, and fundraising.",
